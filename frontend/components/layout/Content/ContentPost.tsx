...
type ContentPostProps = {
  post: ContentIndexVariant["posts"][number];
  index: number;
};

export const ContentPost = ({ post, index }: ContentPostProps) => {
  return (
    <li className="col-span-full rounded-lg md:col-span-2 lg:col-span-6 xl:col-span-4">
      <Transition
        delay={0.15 * index}
