/**
 * This file has to be written as plain JS because it is imported in the
 * Next config which has no Typescript support
 * We also can't import any modules because they are either in TS or use
 * aliases for their imports
 */
