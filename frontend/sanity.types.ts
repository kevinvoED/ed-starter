...
// Source: ../frontend/sanity/queries/queries.ts
// Variable: LLMS_QUERY
// Query: fn fn::img($image) = $image {      ...,  asset->{    _id,    url,    metadata {      lqip,      dimensions {        width,        height      }    }  }  };    fn fn::imgs($images) = $images[] {      ...,  asset->{    _id,    url,    metadata {      lqip,      dimensions {        width,        height      }    }  }  };    fn fn::logo($logo) = $logo {      ...,  asset->{    _id,    url,    metadata {      lqip,      dimensions {        width,        height      }    }  }  };    fn fn::links($links) = $links[] {      ...,  _key,  "href": select(    type == "external" => href,    @.internalLink->slug.current == "index" => "/",    @.internalLink->_type == "blog-index" => "/blog",    @.internalLink->_type == "blog-post" => "/blog/" + @.internalLink->slug.current,    @.internalLink->_type == "case-studies-index" => "/case-studies",    @.internalLink->_type == "case-study" => "/case-studies/" + @.internalLink->slug.current,    @.internalLink->_type == "platform-index" => "/platform",    @.internalLink->_type == "platform-child" => "/platform/" + @.internalLink->slug.current,    "/" + @.internalLink->slug.current  )  };    fn fn::ptPlain($content) = $content[] {    ...,    markDefs[]{      ...,      _type == "link" => {          ...,  _key,  "href": select(    type == "external" => href,    @.internalLink->slug.current == "index" => "/",    @.internalLink->_type == "blog-index" => "/blog",    @.internalLink->_type == "blog-post" => "/blog/" + @.internalLink->slug.current,    @.internalLink->_type == "case-studies-index" => "/case-studies",    @.internalLink->_type == "case-study" => "/case-studies/" + @.internalLink->slug.current,    @.internalLink->_type == "platform-index" => "/platform",    @.internalLink->_type == "platform-child" => "/platform/" + @.internalLink->slug.current,    "/" + @.internalLink->slug.current  )      }    },    _type == "links" => {        ...,  _key,  "href": select(    type == "external" => href,    @.internalLink->slug.current == "index" => "/",    @.internalLink->_type == "blog-index" => "/blog",    @.internalLink->_type == "blog-post" => "/blog/" + @.internalLink->slug.current,    @.internalLink->_type == "case-studies-index" => "/case-studies",    @.internalLink->_type == "case-study" => "/case-studies/" + @.internalLink->slug.current,    @.internalLink->_type == "platform-index" => "/platform",    @.internalLink->_type == "platform-child" => "/platform/" + @.internalLink->slug.current,    "/" + @.internalLink->slug.current  )    }  };    fn fn::pt($content) = $content[] {    ...,    markDefs[]{      ...,      _type == "link" => {          ...,  _key,  "href": select(    type == "external" => href,    @.internalLink->slug.current == "index" => "/",    @.internalLink->_type == "blog-index" => "/blog",    @.internalLink->_type == "blog-post" => "/blog/" + @.internalLink->slug.current,    @.internalLink->_type == "case-studies-index" => "/case-studies",    @.internalLink->_type == "case-study" => "/case-studies/" + @.internalLink->slug.current,    @.internalLink->_type == "platform-index" => "/platform",    @.internalLink->_type == "platform-child" => "/platform/" + @.internalLink->slug.current,    "/" + @.internalLink->slug.current  )      }    },    _type == "links" => {        ...,  _key,  "href": select(    type == "external" => href,    @.internalLink->slug.current == "index" => "/",    @.internalLink->_type == "blog-index" => "/blog",    @.internalLink->_type == "blog-post" => "/blog/" + @.internalLink->slug.current,    @.internalLink->_type == "case-studies-index" => "/case-studies",    @.internalLink->_type == "case-study" => "/case-studies/" + @.internalLink->slug.current,    @.internalLink->_type == "platform-index" => "/platform",    @.internalLink->_type == "platform-child" => "/platform/" + @.internalLink->slug.current,    "/" + @.internalLink->slug.current  )    },      _type == "richTable" => {      ...,        _type,        _key,        hasColumnTitles,        hasRowTitles,        columnHeaders[]{          _key,          _type,          cellIndex,          title,        },        rows[]{          _key,          _type,          cells[]{            _key,            _type,            content[]{              ...,              markDefs[]{                ...,                _type == "link" => {                  _type,                  _key,                  href,                },              },            },          },        },      },  };  {    "pages": *[_type == "page" && !meta.noindex && defined(slug)] | order(slug.current) {        "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),      "title": coalesce(meta.title, pt::text(title), slug.current),      "description": coalesce(meta.description, pt::text(description))    },    "blog": {      "index": *[_type == "blog-index"][0] {          "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),        "title": coalesce(meta.title, pt::text(title), "Blog"),        "description": coalesce(meta.description, pt::text(description))      },      "posts": *[_type == "blog-post" && !meta.noindex && defined(slug)] | order(publishedDate desc) {          "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),        "title": coalesce(meta.title, pt::text(title), slug.current),        "description": coalesce(meta.description, pt::text(description))      }    },    "caseStudies": {      "index": *[_type == "case-studies-index"][0] {          "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),        "title": coalesce(meta.title, pt::text(title), "Case Studies"),        "description": coalesce(meta.description, pt::text(description))      },      "posts": *[_type == "case-study" && !meta.noindex && defined(slug)] | order(publishedDate desc) {          "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),        "title": coalesce(meta.title, pt::text(title), slug.current),        "description": coalesce(meta.description, pt::text(description))      }    },    "platform": {      "index": *[_type == "platform-index"][0] {          "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),        "title": coalesce(meta.title, pt::text(title), "Platform"),        "description": coalesce(meta.description, pt::text(description))      },      "children": *[_type == "platform-child" && !meta.noindex && defined(slug)] | order(slug.current) {          "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),        "title": coalesce(meta.title, pt::text(title), slug.current),        "description": coalesce(meta.description, pt::text(description))      }    }  }
...
// Query: *[_type in $viewableTypes && !meta.noindex && defined(slug)] | order(slug.current) {      "url": select(    slug.current == "index" => $baseUrl + "/",    _type == "blog-index" => $baseUrl + "/blog",    _type == "blog-post" => $baseUrl + "/blog/" + slug.current,    _type == "case-studies-index" => $baseUrl + "/case-studies",    _type == "case-study" => $baseUrl + "/case-studies/" + slug.current,    _type == "platform-index" => $baseUrl + "/platform",    _type == "platform-child" => $baseUrl + "/platform/" + slug.current,    $baseUrl + "/" + slug.current  ),    _type,    "title": coalesce(meta.title, pt::text(title), slug.current),    "description": coalesce(meta.description, pt::text(description)),    "publishedDate": select(defined(publishedDate) => publishedDate, null),    "content": select(      defined(content) => pt::text(content),      defined(modules) => array::join(        array::compact(          modules[] {            "text": select(              _type == "rich-text" => pt::text(content),              _type == "hero-primary" => array::join(                array::compact([pt::text(title), pt::text(description)]),                ""              ),              _type == "driver-text" => array::join(                array::compact([pt::text(title), pt::text(description)]),                ""              ),              null            )          }.text        ),        ""      ),      null    )  }
