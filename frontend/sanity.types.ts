...
export type ModuleLibraryReference = {
  _ref: string;
  _type: "reference";
  _weak?: boolean;
  [internalGroqTypeReferenceTo]?: "module-library";
};

export type GlobalModule = {
  _type: "global-module";
  moduleRef: ModuleLibraryReference;
};
