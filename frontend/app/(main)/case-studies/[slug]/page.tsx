...
import {
  fetchSanityCaseStudiesSlugPage,
  fetchSanityCaseStudiesSlugsStaticParams,
...
export async function generateStaticParams() {
  const posts = await fetchSanityCaseStudiesSlugsStaticParams();
...
export async function generateMetadata(props: {
  ...
  const post = await fetchSanityCaseStudiesSlugPage({
    slug: params.slug,
  });
