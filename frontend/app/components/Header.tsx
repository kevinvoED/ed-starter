      ...
      <div className="container px-2 py-6 sm:px-6">
        <div className="flex items-center justify-between gap-5">
          <Link className="flex items-center gap-2" href="/">
            <span className="pl-2 font-semibold text-lg sm:text-2xl">
          ...
          <nav>
            <ul
              role="list"
              className="flex items-center gap-4 font-mono text-xs leading-5 tracking-tight sm:text-base md:gap-6"
            >
              <li>
              ...
              <li className="flex before:block sm:gap-4 sm:before:w-[1px] sm:before:bg-gray-200 md:gap-6">
                ...
                >
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="hidden h-4 sm:block sm:h-6"
                  >
